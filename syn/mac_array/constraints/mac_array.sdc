...
#set_multicycle_path -setup 12 -to [get_cells sfp_instance/sfp_out_sign*]
#set_multicycle_path -hold 11 -to [get_cells sfp_instance/sfp_out_sign*]
#set_multicycle_path -setup 12 -from sum_in* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -setup 12 -from sfp_instance/sfp_in* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -setup 12 -from sfp_instance/fifo_inst_int/q* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -setup 12 -from sfp_instance/fifo_inst_int/rd_ptr* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -hold 11 -from sfp_instance/sfp_in* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -hold 11 -from sfp_instance/fifo_inst_int/q* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -hold 11 -from sfp_instance/fifo_inst_int/rd_ptr* -to sfp_instance/sfp_out_sign*
#set_multicycle_path -hold 11 -from sum_in* -to sfp_instance/sfp_out_sign*
