set top_module sram_w16_64
set rtlPath "../verilog_dualcore"

# Target library
set target_library /home/linux/ieng6/ee260bwi24/public/PDKdata/db/tcbn65gplustc.db 
...
analyze -format verilog -lib WORK sram_w16_64.v
...
write -format verilog -hier -output [format "%s%s" $top_module .64bit.out.v]
